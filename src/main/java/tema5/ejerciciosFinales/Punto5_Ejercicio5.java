...
public class Punto5_Ejercicio5 {
	...
	/* Comento porque voy a codificarlo de otra manera
	...
	// ********************************************************************************
	// *   AÑADO ESTA PARTE DE CÓDIGO PARA EJERCICIO 5                                *
	// ********************************************************************************
	// No puedo sobrecargar con los mismos argumentos
	// en este caso he comentado el código del ejercicio 3 (la carga por teclado)
	// Si lo descomentas te dará error
	private static void carga(int cuadricula[][]) {
